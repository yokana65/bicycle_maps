...
Set up the data directory to load preprocessed data:
...
municipalities <- st_read("VG250_GEM.shp")
# str(municipalities)

# Convert the shapefile into a tibble
municipalities_tb <- as_tibble(municipalities) %>% select(OBJID, GEN, geometry)
